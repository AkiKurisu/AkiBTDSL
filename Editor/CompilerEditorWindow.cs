...
namespace Kurisu.AkiBT.DSL.Editor
{
    public class CompilerEditorWindow : EditorWindow
    {
        ...
        private BehaviorTreeSO outputTree;
        ...
        private void DrawCompile()
        {
            ...
            GUI.enabled = false;
            EditorGUILayout.ObjectField(outputTree, typeof(BehaviorTree), false);
            GUI.enabled = true;
            ...
            if (state == 1 && GUILayout.Button("Export", GUILayout.MinHeight(25)))
            {
                ...
                AssetDatabase.CreateAsset(outputTree, outPutPath);
        ...
        private int Compile()
        {
            ...
            outputTree = new Compiler(fileInStreaming).Verbose(true).Compile(InputCode);
            return 1;
        }
        ...
        private void WriteNodeTypeRegistry()
        {
            ...
            if (EnableMask) (showGroups, notShowGroups) = BehaviorTreeSetting.GetMask(EditorName);
            if (showGroups != null)
            {
